...
class PathIterator(image.Iterator):
    ...
    def __init__(self,
        ...
        self.samples = sum(pool.map(function_partial, paths))
        ...
        pool.close()
        pool.join()
        super(PathIterator, self).__init__(self.samples, batch_size, shuffle, seed)
